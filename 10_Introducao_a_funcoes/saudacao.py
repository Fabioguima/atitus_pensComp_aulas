...
print(saudacao("Matheus") == "Olá, Sr. Matheus")
print(saudacao("Matheus", "Jardim") == "Olá, Sr. Matheus Jardim")
print(saudacao("Matheus", "Jardim", "Prof") == "Olá, Prof Matheus Jardim")
print(saudacao("Matheus", titulo="Prof") == "Olá, Prof Matheus")
print(saudacao("") == "Olá!")
